  ...
  items = [
    {
      ...
      answer: (
        <>
          ...
          <p className="text-muted-foreground mb-4 max-w-[640px] text-balance">
            Otisium helps you ship faster without compromising on quality.
          </p>
        </>
      ),
    },
      ...
      answer: (
        <>
          ...
          <p className="text-muted-foreground mb-4 max-w-[600px]">
            ...
            Otisium gives you full control of your code while maintaining
    ...
    {
      question:
        "How Otisium is different from other components libraries and templates?",
      answer: (
        <>
          <p className="text-muted-foreground mb-4 max-w-[580px]">
            Otisium stands out with premium design quality and delightful
          ...
          <p className="text-muted-foreground mb-4 max-w-[640px] text-balance">
            ...
            dependencies, Otisium is built with modern technologies and best
            practices in mind.
          </p>
        </>
      ),
    },
    {
      ...
      answer: (
        <>
          <p className="text-muted-foreground mb-4 max-w-[580px]">
            The basic version of Otisium is open-source and free forever,
    ...
    },
    {
      ...
      answer: (
        <p className="text-muted-foreground mb-4 max-w-[580px]">
          Yes! The complete Otisium template is available for free on the{" "}
          <Link
